...
const Main = ({ auth, children, title="Dashboard" }) => {
    ...
    return (
        <div className="bg-gray-200 min-h-[120vh] h-full">
            <div className="min-h-[400px] bg-[url('https://images.hdqwalls.com/wallpapers/mountain-landscape-illustration-ls.jpg')] bg-blue-400 z-1 bg-blend-overlay absolute w-full"></div>
